...
public class DayWeatherForecast : Entity<WeatherForecastId>
{
    ...
    public static DayWeatherForecast Create(DateTime date, CityId cityId)
    ...
    private DayWeatherForecast(WeatherForecastId id) : base(id) { }
}